...
const { createLyrics, updateLyricsById, getLyricsId, addViewCount, getAllLyrics, deleteLyrics, searchLyrics, getLyricsOverview, getTopLyrics, getLyricsCountByArtist, getLyricsByArtist, disableLyrics, getDisableLyrics, getEnableLyrics, searchLyricsByAdmin, getLyricsByArtistByAdmin, enableLyrics } = require('../controllers/lyricsController');
...
lyricsRouter.get('/enableLyrics/:id', authenticateUser, checkRole(['admin']), enableLyrics)
